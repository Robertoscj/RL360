    ...
    <div className="glass-card p-4">
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/[0.06] p-3">
          ...
          <p className="text-[10px] text-slate-500">Margem {formatarPercentual(margem, 1)}</p>
        </div>
        <div className="rounded-lg border border-red-500/20 bg-red-500/[0.06] p-3">
          ...
          <p className="text-[10px] text-slate-500">{formatarPercentual(pctCusto, 1)} do faturamento</p>
        </div>
      </div>
